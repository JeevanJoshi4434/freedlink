...
import { uploadPost } from './Redux/apiCall';
          ...
          <div className='leftBar-notification'>
            <div className='NotificationsContainer'>
              <div style={{ display: "flex", justifyContent: "space-around", marginBottom: "20px" }}>
                <p style={{ marginTop: "10px" }}>Notifications</p>
                <p style={{ color: "#aaa", marginTop: "10px" }}>See all</p>
              </div>
              <div style={{ display: 'flex', alignItems: "center", marginBottom: "15px" }}>
                <img className=" notificationImg"
                  ...
                  alt="" />
                <p style={{ marginLeft: "5px", color: "#aaa", fontSize: 13, textAlign: "start", width: "120px" }}>Jeet Started to Following you</p>
                <img className="followingUserImg"
                  src="data:image/png;base64,"
                  alt="" />
              </div>
              <div style={{ display: 'flex', alignItems: "center", marginBottom: "15px" }}>
            ...
            <div className="messageSender__top">
              ...
              <div className="messageSender__option">
                <label className="messageSender__option" htmlFor='file' >
                  ...
                  <h3>Photo</h3>
                  <input type="file" accept="image/*" name="file" id="file" style={{ display: "none" }} onChange={(e) => { setFile(e.target.files[0]); setPreImage(window.URL.createObjectURL(e.target.files[0])) }} />
                </label>
              </div>

              <div className="messageSender__option">
                <span style={{ color: "orange", cursor: "pointer" }} onClick={handleUploadImg} className="material-icons"> send </span>
                <h3>Post</h3>
              </div>
            </div>
          </div>
